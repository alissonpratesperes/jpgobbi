...
var new_scroll_position = 0; var last_scroll_position; var smartNavBarCall = document.querySelector('section#header'); window.addEventListener('scroll', function(e){ last_scroll_position = window.scrollY; if(new_scroll_position < last_scroll_position && last_scroll_position > 80) { smartNavBarCall.style.top = '-100px'; } else if ( new_scroll_position > last_scroll_position ) { smartNavBarCall.style.top = '0px'; } new_scroll_position = last_scroll_position; });